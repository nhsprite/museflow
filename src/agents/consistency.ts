...
${state.chapterContent || '（无内容）'}
 ...
 一致性检测维度：
  ...
  4a. **时间线锚定检查（新增重点）**：
    - 角色在叙述、回忆、内心独白中提及的事件，必须是该角色已经经历过的、或明确被告知的、或在预言/梦境等超现实场景中看到的
    - 严禁角色将尚未发生的事件描述为"回忆"、"往事"、"曾经"
    - 如果角色提及未来事件，必须使用"将要"、"等待"、"命中注定"等前瞻性措辞，且必须是在明确的预言、梦境或仙境场景中
    - 特别注意：前世记忆、命运预示等内容容易混淆时间线，必须严格区分"已发生的回忆"和"未发生的预示"
